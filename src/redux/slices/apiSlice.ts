...
export const organizationThunk = createAsyncThunk<FetchOrganizationsResponse>(
...
export const repositoryThunk = createAsyncThunk<Repository[], Organization[]>(
  "api/fetchRespositories",
  async (organizations: Organization[], thunkAPI) => {
    try {
      const repositories = [];
